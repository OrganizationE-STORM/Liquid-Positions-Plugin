...
export interface IAbstractPluginInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "afterFlash"
      | "afterInitialize"
...
export interface IAbstractPlugin extends BaseContract {
  connect(runner?: ContractRunner | null): IAbstractPlugin;
  waitForDeployment(): Promise<this>;

  interface: IAbstractPluginInterface;
