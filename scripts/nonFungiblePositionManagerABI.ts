export const NonFungiblePositionManager_ABI = [
	...
	{ inputs: [], name: "factory", outputs: [{ internalType: "address", name: "", type: "address" }], stateMutability: "view", type: "function" },
	{
		...
		outputs: [{ internalType: "address", name: "farmingCenterAddress", type: "address" }],
		stateMutability: "view",
		type: "function",
	},
	{ inputs: [], name: "farmingCenter", outputs: [{ internalType: "address", name: "", type: "address" }], stateMutability: "view", type: "function" },
	{
		inputs: [{ internalType: "uint256", name: "tokenId", type: "uint256" }],
		name: "getApproved",
	...
	{
		inputs: [{ internalType: "address", name: "newFarmingCenter", type: "address" }],
