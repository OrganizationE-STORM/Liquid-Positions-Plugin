export const AlgebraPool_ABI = [
	...
	{ inputs: [], name: "incorrectPluginFee", type: "error" },
	...
	{ inputs: [], name: "zeroLiquidityDesired", type: "error" },
	{
		...
		inputs: [
			...
			{ indexed: false, internalType: "uint24", name: "pluginFee", type: "uint24" },
		],
		name: "Burn",
		type: "event",
	},
	...
	},
	{
		...
		inputs: [
			...
			{ indexed: false, internalType: "int24", name: "tick", type: "int24" },
			{ indexed: false, internalType: "uint24", name: "overrideFee", type: "uint24" },
			{ indexed: false, internalType: "uint24", name: "pluginFee", type: "uint24" },
		],
		name: "Swap",
		type: "event",
